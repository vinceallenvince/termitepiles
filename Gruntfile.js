module.exports = function(grunt) {
  ...
  var standaloneNamespace = 'TermitePiles';
  var latest = '<%= pkg.name %>';
  ...
  grunt.initConfig({
    ...
    exec: {
      ...
      browserify: 'mkdir ' + releaseDir + ' && browserify ./src/main.js --standalone ' + standaloneNamespace + ' -t browserify-handlebars -o ' + devRelease,
